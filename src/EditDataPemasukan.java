...
public class EditDataPemasukan extends javax.swing.JFrame {
    ...
    public EditDataPemasukan(History formHistory,DefaultComboBoxModel model, int idPemasukan, String jenisPemasukanMulaMula, String tanggalMulaMula, String bulanMulaMula, String tahunMulaMula, String keteranganMulaMula, int jumlahMulaMula) {
        initComponents();
        this.formHistory=formHistory;
        cbJenisPemasukan.setModel(model);
        this.idPemasukan=idPemasukan;
        cbJenisPemasukan.setSelectedItem(jenisPemasukanMulaMula);
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        String tanggalPemasukanStlhEdit=tahunStlhEdit+"-"+bulanStlhEdit+"-"+tanggalStlhEdit;
        String keteranganStlhEdit=tfKeterangan.getText();
        int jumlahStlhEdit=(int)spJumlah.getValue();
        String sql="SELECT id_jenis FROM jenis WHERE jenis='"+cbJenisPemasukan.getSelectedItem().toString()+"';";
        try{
            Connection con=ModuleDB.connectDB();
            Statement stmt=con.createStatement();
            ResultSet result=stmt.executeQuery(sql);
            result.next();
            idJenisPemasukanStlhEdit=result.getInt(1);
            sql="UPDATE pemasukan SET id_jenis="+idJenisPemasukanStlhEdit+",tanggal='"+tanggalPemasukanStlhEdit+"',keterangan='"+keteranganStlhEdit+"',jumlah="+jumlahStlhEdit+" WHERE id_pemasukan="+idPemasukan;
            stmt.executeUpdate(sql);
            con.close();
            showMessageDialog(null,"Data pemasukan berhasil diedit!");
            formHistory.loadHistoryPemasukan();
        }
