...
public class TambahPemasukan extends javax.swing.JFrame {
    ...
    public TambahPemasukan(String keterangan){
        initComponents();
        tfKeterangan.setText(keterangan);
        cbJenisPemasukan.setEnabled(false);
    }
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        String jenisPemasukan=cbJenisPemasukan.getSelectedItem().toString();
        int idJenisPemasukan;
        ...
        String tanggalPemasukan=tahun+"-"+bulan+"-"+tanggal;
        String keterangan=tfKeterangan.getText();
        int jumlah=(int)spJumlah.getValue();
        try{
            String sql="SELECT id_jenis FROM jenis WHERE jenis='"+jenisPemasukan+"';";
            Connection con=ModuleDB.connectDB();
            Statement stmt=con.createStatement();
            ResultSet result=stmt.executeQuery(sql);
            result.next();
            idJenisPemasukan=result.getInt(1);
            sql="INSERT INTO pemasukan (id_user,id_jenis,tanggal,keterangan,jumlah) VALUES ("+ModuleDB.idUser+","+idJenisPemasukan+",'"+tanggalPemasukan+"','"+keterangan+"',"+jumlah+");";
            stmt.executeUpdate(sql);
            showMessageDialog(null,"Data pemasukan berhasil ditambahkan!");
            con.close();
        }
        catch(SQLException e){
            showMessageDialog(null,e.getMessage());
