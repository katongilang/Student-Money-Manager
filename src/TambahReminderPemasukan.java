 ...
 * @author Felix
 */
public class TambahReminderPemasukan extends javax.swing.JFrame {

    /**
     * Creates new form TambahReminderPemasukan
     */
    public TambahReminderPemasukan() {
        initComponents();
    }
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        if(!keterangan.isEmpty()){
            if(rbMingguan.isSelected()){
                ...
                sql="INSERT INTO reminder_pemasukan (id_user,id_kategori_reminder,id_hari,keterangan,enabled) VALUES ("+ModuleDB.idUser+",2,"+idHari+",'"+keterangan+"',"+enabled+");";
                try{
                    Connection con=ModuleDB.connectDB();
                    Statement stmt=con.createStatement();
                    stmt.executeUpdate(sql);
                    con.close();
                    showMessageDialog(null,"Reminder pemasukan berhasil disimpan!");
                }
                ...
                sql="INSERT INTO reminder_pemasukan (id_user,id_kategori_reminder,tanggal,keterangan,enabled) VALUES ("+ModuleDB.idUser+",3,"+tanggal+",'"+keterangan+"',"+enabled+");";
                try{
                    Connection con=ModuleDB.connectDB();
                    Statement stmt=con.createStatement();
                    stmt.executeUpdate(sql);
